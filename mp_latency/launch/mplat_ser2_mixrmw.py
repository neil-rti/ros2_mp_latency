...
rmw_sub_type = 'rmw_connextdds'             # rmw selection for subscriber, default to Connext pro
if 'RMW_IMPLEMENTATION_SUB' in os.environ:
    rmw_sub_type = os.environ['RMW_IMPLEMENTATION_SUB']
...
if 'RMW_IMPLEMENTATION' in os.environ:
    config_name = os.environ['RMW_IMPLEMENTATION']
...
rmw_env_sub = os.environ.copy()
rmw_env_sub['RMW_IMPLEMENTATION'] = rmw_sub_type
...
def generate_launch_description():
    ...
    sink_node = Node(
        ...
        executable=exe_sink,
        output='screen',
        arguments=[test_duration, rely_type, pub_frequency, str(total_nodes), sink_node_topic_name, rmw_sub_type, config_name],
        name='sink'
    )
